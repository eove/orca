...
At first, before selecting the commit at which the OR.C.A document is signed, **please make sure the prerequisites for the signing method you are going to use are fullfilled**.
