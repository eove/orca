...
A gpg-based one can be found in [the O.R.CA documentation](https://eove.github.io/orca/v1.1.0/signing_and_verifying.html)

Once ce document is verified, for easier copy/paste of commands in this document, we recommend to use a [HTML version of this workflow](https://eove.github.io/orca/v1.1.0/document_generation.html), generated at the above commit.
...
If a word used in this document is unknown to you, the [O.R.CA documentation contains a glossary explaining key concepts](https://eove.github.io/orca/v1.1.0/glossary.html)
...
The process is detailed in [O.R.CA's documentation](https://eove.github.io/orca/v1.1.0/hardware_tokens.html).
...
> In such situations, you should immediately [revoke (and publish) the PEM that the offline vault just signed](https://eove.github.io/orca/v1.1.0/revocation.html). This requires running a new ceremony.
...
- Or you can create a brand new offline root CA.\
  ...
  Please read [the documentation on how to setup a new PKI](https://eove.github.io/orca/v1.1.0/pki_init.html).
